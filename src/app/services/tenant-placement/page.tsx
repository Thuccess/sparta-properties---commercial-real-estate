...
import { UserCheck, ShieldCheck, Search, FileCheck, CheckCircle2, ArrowRight, Users, Clock } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/80 leading-relaxed font-light max-w-3xl font-sans">
              Strategic tenant matching and placement services to ensure optimal occupancy and rental income.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6 font-sans">
                  Our tenant placement service focuses on finding the right tenants for your properties. We conduct thorough tenant screening, background checks, and credit verification to ensure reliable, long-term tenants.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mb-8 font-sans">
                  Our extensive network and marketing expertise help minimize vacancy periods and maximize rental yields. We understand that quality tenants are the foundation of successful property investments.
                </p>
              </div>

              <div>
                <h3 className="text-2xl font-serif font-bold text-corporate-navy mb-6">Our Tenant Placement Process:</h3>
                <div className="space-y-6">
                  {[
                    { icon: Search, title: 'Property Marketing', desc: 'Strategic marketing across multiple channels to attract qualified prospects' },
                    { icon: Users, title: 'Tenant Screening', desc: 'Comprehensive background checks, credit verification, and reference checks' },
                    { icon: FileCheck, title: 'Application Processing', desc: 'Efficient processing of applications with detailed evaluation' },
                    { icon: ShieldCheck, title: 'Lease Negotiation', desc: 'Professional lease negotiation to secure favorable terms' },
                    { icon: Clock, title: 'Quick Placement', desc: 'Minimize vacancy periods with our efficient placement process' }
                  ].map((item, idx) => (
              ...
              <div className="bg-corporate-cream p-8 sm:p-10 border border-corporate-blue/20">
                <h3 className="text-2xl font-serif font-bold text-corporate-navy mb-4">Benefits of Our Service:</h3>
                <ul className="space-y-4">
                  {[
                    'Reduced vacancy periods through effective marketing',
                    'Quality tenants with verified backgrounds',
                    'Higher rental yields through proper tenant matching',
                    'Reduced risk of payment defaults',
                    'Professional lease documentation and compliance',
            ...
            <div className="lg:col-span-1">
              <div className="bg-corporate-cream p-8 sm:p-10 border border-corporate-blue/20 sticky top-32">
                ...
                <p className="text-gray-700 mb-6 font-sans">
                  Let us help you find quality tenants for your property.
                </p>
                <Link
                  href="/contact"
