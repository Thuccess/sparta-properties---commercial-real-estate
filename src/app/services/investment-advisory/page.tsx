...
import { TrendingUp, CheckCircle2, ArrowRight, BarChart3, Target, Briefcase } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/80 leading-relaxed font-light max-w-3xl font-sans">
              Data-driven real estate investment strategies for institutional investors and developers.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed font-light mb-6 font-sans">
                  Our investment advisory team provides comprehensive real estate investment guidance, from feasibility studies and market analysis to portfolio optimization and capital markets strategy.
                </p>
                <p className="text-base text-gray-600 leading-relaxed mb-8 font-sans">
                  Navigating the East African real estate market requires deep local insight combined with international best practices. We serve institutional investors, private equity firms, and developers seeking to build or optimize their property portfolios in Uganda and across the region.
                </p>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-corporate-cream p-8 sm:p-10 border border-corporate-blue/20 sticky top-32">
                ...
                <div className="space-y-6">
                  {[
                    { icon: TrendingUp, title: 'Market Intelligence', desc: 'Comprehensive market data and insights' },
                    { icon: BarChart3, title: 'Financial Modeling', desc: 'ROI analysis and projections' },
                    { icon: Target, title: 'Strategic Planning', desc: 'Long-term investment strategies' },
                    { icon: Briefcase, title: 'Transaction Support', desc: 'End-to-end deal execution' }
                  ].map((item, idx) => (
      ...
      <section className="py-24 sm:py-32 bg-corporate-navy text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto font-sans">
            Partner with our advisory team to navigate the complexities of East African real estate investment.
          </p>
          <Link
            href="/contact"
