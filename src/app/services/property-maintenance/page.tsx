...
import { Wrench, CheckCircle2, ArrowRight, Shield, Clock, Settings } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/80 leading-relaxed font-light max-w-3xl font-sans">
              Comprehensive property maintenance and facility management services to preserve and enhance asset value.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed font-light mb-6 font-sans">
                  Our property maintenance team ensures your commercial properties remain in optimal condition, preserving asset value and ensuring tenant satisfaction through proactive maintenance and responsive service.
                </p>
                <p className="text-base text-gray-600 leading-relaxed mb-8 font-sans">
                  Effective property maintenance goes beyond reactive repairs. We implement preventive maintenance programs, coordinate vendor relationships, and ensure compliance with safety and building codes, all while optimizing operational costs and minimizing disruptions to tenants.
                </p>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-corporate-cream p-8 sm:p-10 border border-corporate-blue/20 sticky top-32">
                ...
                <div className="space-y-6">
                  {[
                    { icon: Shield, title: 'Quality Assurance', desc: 'Rigorous standards and inspections' },
                    { icon: Clock, title: 'Rapid Response', desc: '24/7 emergency maintenance support' },
                    { icon: Settings, title: 'System Optimization', desc: 'Energy efficiency and cost savings' },
      ...
      <section className="py-24 sm:py-32 bg-corporate-navy text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-6">
            Keep Your Properties in Peak Condition
          </h2>
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto font-sans">
            Partner with us for comprehensive property maintenance that protects your investment.
          </p>
          <Link
            href="/contact"
