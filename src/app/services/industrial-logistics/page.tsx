...
import { Warehouse, CheckCircle2, ArrowRight, Truck, MapPin, Zap } from 'lucide-react';

const CheckCircle = ({ className }: { className?: string }) => (
  <CheckCircle2 className={className} size={20} strokeWidth={2.5} />
);

export default function IndustrialLogistics() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/80 leading-relaxed font-light max-w-3xl font-sans">
              Specialized industrial and logistics facilities designed for operational efficiency and regional distribution.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <p className="text-lg text-gray-700 leading-relaxed font-light mb-6 font-sans">
                  Our industrial and logistics division specializes in warehousing, distribution centers, manufacturing facilities, and specialized industrial properties across East Africa's key logistics corridors.
                </p>
                <p className="text-base text-gray-600 leading-relaxed mb-8 font-sans">
                  Industrial real estate requires deep understanding of operational requirements, supply chain dynamics, and infrastructure needs. We work with manufacturers, distributors, and logistics companies to identify and secure facilities that optimize their operations and support regional growth strategies.
                </p>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-corporate-cream p-8 sm:p-10 border border-corporate-blue/20 sticky top-32">
                ...
                <div className="space-y-6">
                  {[
                    { icon: Warehouse, title: 'Strategic Locations', desc: 'Prime industrial zones and logistics hubs' },
                    { icon: Truck, title: 'Transport Access', desc: 'Proximity to ports and highways' },
                    { icon: MapPin, title: 'Market Intelligence', desc: 'Deep knowledge of industrial markets' },
                    { icon: Zap, title: 'Operational Efficiency', desc: 'Facilities designed for productivity' }
                  ].map((item, idx) => (
      ...
      <section className="py-24 sm:py-32 bg-corporate-navy text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-6">
            Find Your Ideal Industrial Facility
          </h2>
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto font-sans">
            Connect with our industrial real estate specialists to discover facilities that power your operations.
          </p>
          <Link
            href="/contact"
