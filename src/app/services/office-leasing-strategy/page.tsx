...
import { Building2, CheckCircle2, ArrowRight, Users, FileText, TrendingUp } from 'lucide-react';

const CheckCircle = ({ className }: { className?: string }) => (
  <CheckCircle2 className={className} size={20} strokeWidth={2.5} />
);

export default function OfficeLeasingStrategy() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/80 leading-relaxed font-light max-w-3xl font-sans">
              Strategic office space solutions that align with your corporate objectives and drive operational excellence.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                <h2 className="text-3xl sm:text-4xl font-serif font-bold text-corporate-navy mb-6">
                  Comprehensive Office Leasing Solutions
                </h2>
                <p className="text-lg text-gray-700 leading-relaxed font-light mb-6 font-sans">
                  Our office leasing specialists combine deep market intelligence with strategic negotiation expertise to secure premium office spaces that enhance your corporate presence in Kampala and across East Africa.
                </p>
                <p className="text-base text-gray-600 leading-relaxed mb-8 font-sans">
                  We understand that office space is more than just square footage—it's a strategic asset that impacts employee productivity, brand perception, and operational efficiency. Our team works closely with multinational corporations, regional headquarters, and growing businesses to identify and secure spaces that align with their unique requirements.
                </p>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-corporate-cream p-8 sm:p-10 border border-corporate-blue/20 sticky top-32">
                ...
                <div className="space-y-6">
                  {[
                    { icon: Building2, title: 'Market Intelligence', desc: 'Proprietary data on Kampala office market' },
                    { icon: Users, title: 'Tenant Advocacy', desc: 'Dedicated representation throughout the process' },
                    { icon: FileText, title: 'Strategic Planning', desc: 'Long-term space strategy development' },
                    { icon: TrendingUp, title: 'Value Optimization', desc: 'Maximize ROI on your office investment' }
                  ].map((item, idx) => (
      ...
      <section className="py-24 sm:py-32 bg-corporate-navy text-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          ...
          <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto font-sans">
            Let our experts guide you through the Kampala office market and secure a space that elevates your business.
          </p>
          <Link
            href="/contact"
